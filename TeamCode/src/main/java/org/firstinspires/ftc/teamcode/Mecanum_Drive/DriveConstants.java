...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(22, 0, 3, 12.8);
    ...
    public static double GEAR_RATIO = 0.985; // output (wheel) speed / input (motor) speed
